...
docker rmi asif449/cloud-production-website:06 && \
docker pull asif449/cloud-production-website:07 && \
docker run -d --name cloudproduction-app -p 3000:3000 --restart unless-stopped asif449/cloud-production-website:07
